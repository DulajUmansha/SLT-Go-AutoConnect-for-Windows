...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(u"SLT Go")
        icon = QIcon()
        icon.addFile(u":/images/AF_FON_RGB_white.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/images/home.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/images/info.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/images/link.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/images/link-slash.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/images/user.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.page_disconnect.setObjectName(u"page_disconnect")
        ...
        self.page_wait.setObjectName(u"page_wait")
        ...
        self.label_usernName.setObjectName(u"label_usernName")
        font3 = QFont()
        ...
        icon6 = QIcon()
        icon6.addFile(u":/images/disk.svg", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_password.setPlaceholderText(QCoreApplication.translate("MainWindow", u"**********", None))
        self.lineEdit_userName.setPlaceholderText(QCoreApplication.translate("MainWindow", u"94123456789@sltgo", None))
        self.label_usernName.setText(QCoreApplication.translate("MainWindow", u"User Name", None))
